...
*NOMOR CREATOR*
▼▼▼▼▼`)
sendKontak(from, `6282139089054`, `${ownerName}`, 'プルワディ')
               await sleep(1000)
               break
               case 'spamcall':{
...
*☯➳️* _*${prefix}GROUPMENU*_
*☯➳* _*${prefix}WIBUMENU*_
*☯➳* _*${prefix}STICKERMENU*_
*☯➳* _*${prefix}OWNERMENU*_
*☯➳* _*${prefix}GAMEMENU*_
*☯➳* _*${prefix}MENUMAKER*_
*☯➳* _*${prefix}FUNMENU*_
*☯➳* _*${prefix}DOWNLOADMENU*_
*☯➳* _*${prefix}INFOMENU*_
*☯➳* _*${prefix}OTHERMENU*_
*☯➳* _*${prefix}SEWABOT*_
*☯➳* _*${prefix}18+*_
*☯➳* _*${prefix}ISLAMMENU*_
*☯➳* _*${prefix}RANDOMTEKS*_
*☯➳* _*${prefix}MOVIEMENU*_
*☯➳* _*${prefix}RANDOMIMAGE*_
*☯➳* _*${prefix}EPHOTO*_
*☯➳* _*${prefix}PHOTOKY*_
*☯➳* _*${prefix}TEXTPRO*_
*☯➳* _*${prefix}IMAGEMANI*_
*☯➳* _*${prefix}NSFWMENU*_
...
ikyy.sendMessage(from, loli, MessageType.audio, {quoted: freply, mimetype: 'audio/mp4', ptt:true})
                    ikyy.sendMessage(from, { contentText: `${menu}`, footerText: ' ```𝚃𝚑𝚒𝚜 𝚒𝚜 𝚖𝚎,,, 𝚙𝚞𝚛:𝚟``` ', buttons: [{ buttonId: `!command`, buttonText: { displayText: 'simple menu' }, type: 1 },{ buttonId: `!fitur`, buttonText: { displayText: 'fitur' }, type: 1 },{ buttonId: `!sewabot`, buttonText: { displayText: 'sewa' }, type: 1 },{ buttonId: `!owner`, buttonText: { displayText: 'OWNER 👑' }, type: 1 } ], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: ikyads, contextInfo: {mentionedJid: [sender]}}}, 'buttonsMessage')
              break
case 'f':
case 'lock':
 ikymemek = {
...
*☯➳* ${prefix}wallgravity text1 text2
 `
sendButMessage(from, wibu, `created 𝙿𝚞𝚛𝚝𝚣𝚣𝚢 𝚋𝚘𝚝🌠`, [
          {
            buttonId: `!menu`,
            buttonText: {
              displayText: `back`,
...
`
                   sendButMessage(from, wibu, `プルワディ`, [
          {
            buttonId: `!menu`,
            buttonText: {
              displayText: `back`,
...
*☯⏩➳️* harrypotter text
*☯⏩➳️* carvedwood text
*☯⏩➳️* tiktok text1 text2
*☯⏩➳️* arcade8bit text1 text2
*☯⏩➳️* battlefield4 text1 text2
*☯⏩➳️* pubg text1 text2
...
*☯⏩➳️* watercolor text
*☯⏩➳️* luxurygold text
*☯⏩➳️* galaxywallpaper text
*☯⏩➳️* lighttext text
*☯⏩➳️* beautifulflower text
*☯⏩➳️* puppycute text
*☯⏩➳️* royaltext text
*☯⏩➳️* heartshaped text
*☯⏩➳️* birthdaycake text
...
*☯⏩➳️* snow3d text
*☯⏩➳️* birthdayday text
*☯⏩➳️* goldplaybutton text
*☯⏩➳️* silverplaybutton text
*☯⏩➳️* freefire text
...
`
        ...
        case 'wasted':
              ...
              buttonsMessage = {footerText:'𝙿𝚞𝚛𝚝𝚣𝚣𝚢 𝚋𝚘𝚝🌠', imageMessage: imageMsg,
              ...
              ikyy.relayWAMessage(prep)
                ...
                reply (mess.wait)
                  ...
                  buff = await getBuffer(`https://api.lolhuman.xyz/api/photooxy1/${command}?apikey=${setting.lolkey}&text=${ini_txt}`)
                          buttons = [{buttonId: `!menu`,buttonText:{displayText: `BACK MENU`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'𝙿𝚞𝚛𝚝𝚣𝚣𝚢 𝚋𝚘𝚝🌠T', imageMessage: imageMsg,
              contentText:`Jangan Lupa Follow @purokta`,buttons,headerType:4}
              prep = await ikyy.prepareMessageFromContent(from,{buttonsMessage},{quoted: freply})
              ikyy.relayWAMessage(prep)
...
*☯⏩➳️*  ꜱᴇᴛᴘᴘɢʀᴜᴘ
*☯⏩➳️*  ꜱᴇᴛᴅᴇꜱᴄ
*☯⏩➳️*  ꜱɪᴅᴇʀ *ʀᴇᴘʟʏ ᴄʜᴀᴛ ʙᴏᴛ*
*☯⏩➳️*  ʜɪᴅᴇᴛᴀɢ *ᴛᴇᴋꜱ/ʀᴇᴘʟʏ ᴛᴇᴋꜱ*
...
`
 ...
 𝙿𝚞𝚛𝚝𝚣𝚣𝚢 𝚋𝚘𝚝🌠︎`, imageMessage: imageMsg,
               buttons: buttons,
               headerType: 1
}
...
𝔍𝔞𝔫𝔤𝔞𝔫 𝔭𝔢𝔯𝔫𝔞𝔥 𝔪𝔢𝔫𝔠??𝔫𝔱𝔞𝔦 𝔰𝔢𝔰𝔢𝔬𝔯𝔞𝔫𝔤 
 𝔶𝔞𝔫𝔤 𝔪𝔞𝔰𝔦𝔥 𝔪𝔢𝔫𝔠𝔦𝔫𝔱??𝔦 𝔪𝔞𝔰𝔞𝔩𝔞𝔩𝔲𝔫𝔶𝔞
`
...
`
 ...
 𝐋𝐈𝐒𝐓 𝐌𝐄𝐍𝐔
*☯⏩➳️* ${prefix}dropwater *teks*
*☯⏩➳️* ${prefix}blueneon *teks*
*☯⏩➳️* ${prefix}flowertext *teks*
*☯⏩➳️* ${prefix}tlight *teks*
*☯⏩➳️* ${prefix}epep *teks*
*☯⏩➳️* ${prefix}nulis *teks*
*☯⏩➳️* ${prefix}nulis2 *teks*
*☯⏩➳️* ${prefix}splaybutton *teks*
*☯⏩➳️* ${prefix}gplaybutton *teks*
*☯⏩➳️* ${prefix}cslogo *teks*
*☯⏩➳️* ${prefix}crismes *teks*
*☯⏩➳️* ${prefix}text3d *teks*
*☯⏩➳️* ${prefix}matrix *teks*
*☯⏩➳️* ${prefix}tfire *teks*
*☯⏩➳️* ${prefix}naruto *teks*
*☯⏩➳️* ${prefix}breakwall *teks*
*☯⏩➳️* ${prefix}flametext *teks*
*☯⏩➳️* ${prefix}sandw *teks*
...
𝔍𝔞𝔫𝔤𝔞𝔫 𝔭𝔢𝔯𝔫𝔞𝔥 𝔪𝔢𝔫𝔠𝔦𝔫𝔱𝔞𝔦 𝔰𝔢??𝔢𝔬𝔯𝔞𝔫𝔤 
 𝔶𝔞𝔫𝔤 𝔪𝔞𝔰𝔦𝔥 𝔪𝔢𝔫𝔠𝔦𝔫𝔱𝔞𝔦 𝔪𝔞𝔰𝔞𝔩𝔞𝔩𝔲𝔫𝔶`
...
Ket : Ketik /resetgame , Untuk Mereset Permainan Yg Ada Di Grup!`, text, {contextInfo: {mentionedJid: [player2]}})
     ...
     case 't':
       titid =  `SILAHKAN PILIH DI BAWAH UNTUK MELANJUTKAN`
                   ...
                   sendButMessage(from, titid, `crated 𝙿𝚞𝚛𝚝𝚣𝚣𝚢 𝚋𝚘𝚝🌠︎`, [
          {
            buttonId: `Y`,
            buttonText: {
              displayText: `Y`,
...
*『 𝙿𝚞𝚛𝚝𝚣𝚣𝚢 𝚋𝚘𝚝🌠︎ 』*`
	    ...
	    // console.log(e)
            setTimeout( () => {
			ikyy.updatePresence(from, Presence.composing)
			reply(`*Thank you for late registration 𝙿𝚞𝚛𝚝𝚣𝚣𝚢 𝚋𝚘𝚝🌠*`)
		}, 2000)
        break
case 'sfire':
{
...
`
  buttons = [{buttonId: `${prefix}buypremium`,buttonText:{displayText: `𝐏𝐑𝐄𝐌𝐈𝐔𝐌`},type:1},{buttonId: `${prefix}payment`,buttonText:{displayText: `𝐏𝐀𝐘𝐌𝐄𝐍𝐓`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'𝙿𝚞𝚛𝚝𝚣𝚣𝚢 𝚋𝚘𝚝🌠︎ ', imageMessage: imageMsg,
...
NOTE💫: KENAPA FITUR PREMIUM MAHAL?
KARENA BISA MENGAKSES FITUR JOIN 😘
...
━━━━━━━ •♬• ━━━━━━━
`
  buttons = [{buttonId: `${prefix}owner`,buttonText:{displayText: `owner`},type:1},{buttonId: `${prefix}payment`,buttonText:{displayText: `𝐏𝐀𝐘𝐌𝐄𝐍𝐓`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
...
//------------------< Owner >-------------------
      ...
      case 'broadcast':
             ...
             for (let _ of anu) {
             ikyy.sendMessage(_.jid, bc, image, {quoted:freply,caption: `*『 𝑠𝑢𝑏𝑠𝑐𝑟𝑖𝑏𝑒 』*\n\n${body.slice(4)}`})
}
